...
export default function Header() {
  return (
    <>
      <header className="w-full sticky z-20 top-0 flex items-center justify-between py-4 bg-black bg-opacity-40 backdrop-filter backdrop-saturate-150 backdrop-blur-xl firefox:bg-opacity-100 dark:firefox:bg-opacity-100">
